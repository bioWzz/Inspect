...
# LabA0hpifoursu_exonscount=Rep1LabA0hpiRPKMsOut$counts$foursu$exonCounts

 LabA4hpifoursu_exons=Rep1LabA4hpiRPKMsOut$rpkms$foursu_exons
# LabA4hpifoursu_exonscount=Rep1LabA4hpiRPKMsOut$counts$foursu$exonCounts

LabA8hpifoursu_exons=Rep1LabA8hpiRPKMsOut$rpkms$foursu_exons
# LabA8hpifoursu_exonscount=Rep1LabA8hpiRPKMsOut$counts$foursu$exonCounts
...
colnames(REP1_foursu_exons) <-c("Onehour","Fourhour","Eighthour")
 ...
 #LabA0hpifoursu_intronscount=Rep1LabA0hpiRPKMsOut$counts$foursu$intronCounts

 LabA4hpifoursu_introns=Rep1LabA4hpiRPKMsOut$rpkms$foursu_introns
 #LabA4hpifoursu_intronscount=Rep1LabA4hpiRPKMsOut$counts$foursu$intronCounts

 LabA8hpifoursu_introns=Rep1LabA8hpiRPKMsOut$rpkms$foursu_introns
 #LabA8hpifoursu_intronscount=Rep1LabA8hpiRPKMsOut$counts$foursu$intronCounts
...
simRates <- makeSimModel(REPtest,9, newTpts=NULL, seed=1)
simData1rep <- makeSimDataset(simRates, tpts, 2, seed=NULL)
simData1rep1 <- modelRates(simData1rep, seed=NULL,BPPARAM = bpparam(),
                           verbose = NULL)

rocCurve(simRates, simData1rep1); title("2 replicate - 3 time points", line=3)
